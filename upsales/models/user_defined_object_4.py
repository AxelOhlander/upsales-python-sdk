"""User-defined object 4 models for Upsales API.

This module defines models for user-defined custom objects (slot 4).
"""
...
if TYPE_CHECKING:
    from upsales.types import UserDefinedObject4UpdateFields


class UserDefinedObject4(BaseModel):
    """User-defined object 4 model.
    ...
    categories: list[dict[str, object]] | None = Field(None, description="Category assignments")
    ...
    async def edit(self, **kwargs: Unpack[UserDefinedObject4UpdateFields]) -> UserDefinedObject4:
        ...
        Returns:
            Updated UserDefinedObject4 instance.
        ...
        return await self._client.user_defined_object_4.update(
            self.id, **self.to_api_dict(**kwargs)
        )


class PartialUserDefinedObject4(PartialModel):
    """Partial user-defined object 4 model for nested responses.
    ...
    Example:
        ...
        partial: PartialUserDefinedObject4 = some_object.user_defined_object
        full: UserDefinedObject4 = await partial.fetch_full()
    ...
    async def fetch_full(self) -> UserDefinedObject4:
        """Fetch complete user-defined object data.

        Returns:
            Full UserDefinedObject4 instance.
        ...
        Example:
            ```python
            partial = PartialUserDefinedObject4(id=1, notes="Notes")
        ...
        if not self._client:
            raise RuntimeError("No client available")
        return await self._client.user_defined_object_4.get(self.id)
    ...
    async def edit(self, **kwargs: Unpack[UserDefinedObject4UpdateFields]) -> UserDefinedObject4:
        ...
        if not self._client:
            raise RuntimeError("No client available")
        return await self._client.user_defined_object_4.update(self.id, **kwargs)
