"""User-defined object 1 models for Upsales API.

This module defines models for user-defined custom objects (slot 1).
"""
...
if TYPE_CHECKING:
    from upsales.types import UserDefinedObject1UpdateFields


class UserDefinedObject1(BaseModel):
    """User-defined object 1 model.
    ...
    async def edit(self, **kwargs: Unpack[UserDefinedObject1UpdateFields]) -> UserDefinedObject1:
        ...
        Returns:
            Updated UserDefinedObject1 instance.
        ...
        return await self._client.user_defined_object_1.update(
            self.id, **self.to_api_dict(**kwargs)
        )


class PartialUserDefinedObject1(PartialModel):
    """Partial user-defined object 1 model for nested responses.
    ...
    Example:
        ...
        partial: PartialUserDefinedObject1 = some_object.user_defined_object
        full: UserDefinedObject1 = await partial.fetch_full()
    ...
    async def fetch_full(self) -> UserDefinedObject1:
        """Fetch complete user-defined object data.

        Returns:
            Full UserDefinedObject1 instance.
        ...
        Example:
            ```python
            partial = PartialUserDefinedObject1(id=1, notes="Notes")
        ...
        if not self._client:
            raise RuntimeError("No client available")
        return await self._client.user_defined_object_1.get(self.id)
    ...
    async def edit(self, **kwargs: Unpack[UserDefinedObject1UpdateFields]) -> UserDefinedObject1:
        ...
        if not self._client:
            raise RuntimeError("No client available")
        return await self._client.user_defined_object_1.update(self.id, **kwargs)
